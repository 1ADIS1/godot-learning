...
public class Main : Node
{
	...
	public void CenterCamera(Room room){
		...
		camera.GlobalPosition = room.GlobalPosition + roomCenterOffset;
	}
	...
	private void RemoveEmptyDoors()
	{
		 _map.rooms.FindAll(room => room.Entrances != 0).ForEach(room=>room.RemoveEmptyDoors());
	...
	*/
	...
	private void SetRoom(Room oldRoom, Coordinate coordinate)
	{
		if (_map.IsEmpty())
		{
		...
		var room = oldRoom.Duplicate() as Room;
